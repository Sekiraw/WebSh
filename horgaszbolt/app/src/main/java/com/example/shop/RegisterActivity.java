...
public class RegisterActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCollection = mFirestore.collection("Addresses");
    ...
    public void register(View view) {
        ...
        // add address to db
        addToDB(email, addressEditText);
    }

    public void addToDB(String email, EditText address) {
//        DocumentReference ref = mCollection.document();
//        String key = ref.child("Orders").push().getKey();
